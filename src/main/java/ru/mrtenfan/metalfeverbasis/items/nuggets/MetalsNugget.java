package ru.mrtenfan.metalfeverbasis.items.nuggets;
...
public class MetalsNugget extends Item {
	...
	public void registerIcons(IIconRegister reg) {
	    for (int i = 0; i < metadata.length; i ++) {
	        this.icons[i] = reg.registerIcon("metalfeverbasis:" + metadata[i] + "_nugget");
	    }
	}
	...
	public String getUnlocalizedName(ItemStack stack) {
	    return "item." + metadata[stack.getItemDamage()] + "_nugget";
	}
}
