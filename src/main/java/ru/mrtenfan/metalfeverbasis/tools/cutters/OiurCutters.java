package ru.mrtenfan.metalfeverbasis.tools.cutters;
...
public class OiurCutters extends Item {
	
	private static boolean inf;
	
	public OiurCutters(String name, int dur, boolean infinity) {
		this.setNoRepair();
